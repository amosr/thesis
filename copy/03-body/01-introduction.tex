...
We focus on two streaming models: push streams (\autoref{taxonomy/push}), and Kahn process networks (\autoref{taxonomy/kpn}, \REF{kpn}).
...
[todo: mention fusion failure or deadlocks, as why else would we need Icicle?]
[todo: clustering]
