...
\section{An interview of queries}
Why would we want to run many queries?
Suppose we have a file containing historical prices for a particular stock.
The file contains many records.
Each record contains a date and the average cost for that day, and all the records in the file are sorted by the date.
