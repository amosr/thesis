...
However, a fused process, which performs the job of two input processes, only terminates once both processes are terminated; as such, the fused process would only disconnect once both input processes have terminated.
