...
% This draining is required because each consumer has a finite buffer for each input stream; the producer can only push when all consumers' buffers are not full.
