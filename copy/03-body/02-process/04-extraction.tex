...
\TODO{This subsubsection shows a concrete example of why fusing a producer with a consumer must keep the original stream around.  Is this necessary? It is hard to fit a concrete example in the flow up there, but it feels too late now. Maybe it should go even earlier, next to the fusion algorithm itself.}
