...
We have implemented this fusion system \REFTODO{processes and fusion} in a library called @folderol@\footnote{\url{https://github.com/amosr/folderol}}.
...
\TODO{want a better example, some running example that goes through the whole thesis. Perhaps customer-transactions plus birthdays.}
\begin{lstlisting}
