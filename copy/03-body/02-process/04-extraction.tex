...
% I don't think the recursive-specialisation bug is particularly interesting, or worth talking about.
% Forcing constructor specialisation can be seen as an annotation telling the compiler to try harder, that this particular function is important.
% The implementation must still be careful to limit the number of specialisations to a \emph{finite} amount.
% Constructor specialisation works for arbitrary constructors, 
