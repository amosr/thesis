...
It can also collect statistics on allocations, which is sometimes a more stable performance indicator than runtime, as it is less affected by the whims of the underlying operating system.
