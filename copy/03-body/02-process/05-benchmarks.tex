...
The transformer may perform effects in the \Hs/m/ monad, and return a final result value of type \Hs/r/.
...
The operating system is OS X El Capitan with GHC 8.0.2.
...
The loop generated by Folderol stores the result vector as a boxed object, and reboxes the vector for every iteration it is written to.
...
Folderol & 2-source & 0.42s &   100\% & 8.0e7 & 100\% \\
         ...
         & (2 CPUs, chunk size $10^3$) \\ % & (CPU time 1.09s) \\
         & KPN unfused         & 0.82s &   195\% & 5.7e8 & 713\% \\
         & (4 CPUs, chunk size $10^3$) \\ % & (CPU time 2.6s) \\
