...
Active control is necessary for combinators such as the streaming @join@ operator, as well as @append@.
...
\item[PM]Polarised streams can be used to execute queries with multiple consumers, and requires manual polarity analysis (\cref{taxonomy/polarised})
...
\Cref{03-body/02-process/07-related/table} shows a summary of some of the combinator-based streaming models we have discussed.
We limit the comparison to the closely related work.
