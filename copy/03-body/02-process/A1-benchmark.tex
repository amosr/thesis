...
% \begin{lstlisting}[float,caption=Folderol implementation of \Hs/priceAnalyses/,label=l:a:bench:priceAnalysesFolderol]
...
% \begin{lstlisting}[float,label=l:a:bench:filterMaxFolderol,caption=Folderol implementation of \Hs/filterMax/]
...
\begin{lstlisting}[float,label=l:a:bench:filterMaxVectorShare,caption=Vector / share implementation of \Hs/filterMax/]
...
% \begin{lstlisting}[float,label=l:a:bench:compressorFolderol,caption=Folderol implementation of \Hs/compressor/]
...
% \begin{lstlisting}[float,label=l:a:bench:compressorLopFolderol,caption=Folderol implementation of \Hs/compressor/ with low-pass]
...
% \begin{lstlisting}[float,caption=Folderol implementation of \Hs/append2/]
...
% \begin{lstlisting}[float,label=l:a:bench:part2Folderol,caption=Folderol implementation of \Hs/part2/]
...
\begin{lstlisting}[float,label=l:a:bench:partitionAppendVector,caption=Vector implementations of \Hs/partitionAppend/]
