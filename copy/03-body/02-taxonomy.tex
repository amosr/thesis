...
\FigurePdfLabel{figs/depgraphs/priceOverTime-diamond}{figs/polar/correlation-zip}{Polarised dependency graph with diamond}
...
\Cref{figs/control/correlation-zip} shows the control flow for the polarised diagram, after replacing the edges corresponding to pull streams with filled downward arrows and replacing the edges corresponding to push streams with unfilled upward arrows.
