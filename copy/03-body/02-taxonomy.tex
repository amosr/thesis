...
An alternative streaming model, which allows executing multiple queries at the same time is to use multiple processes of control, as in a \emph{Kahn process network}.
...
We leave discussion of the implementation for \autoref{chapter:process:processes}, and for now focus solely on this simplified version of the interface.
