...
Communication between processes introduces extra overhead: consider when one process sends a machine integer to another process.
...
Another way to reduce the cost of communication is constructing larger processes.
From a functional programming perspective, small, fine-grained processes are desirable, because they allow us to write smaller process for each combinator and compose them together.
...
Compared to the \autoref{taxonomy/pull/streaming-overhead}
