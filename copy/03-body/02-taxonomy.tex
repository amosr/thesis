...
We can also convert a pull stream to a push stream.
We call this operation \emph{draining} the pull stream, where a dr.
...
To convert the other direction and turn a push stream into a pull stream, we would


With @dup_ioi@ and @dup_ooo@ we saw that we can duplicate streams when at least one consumer is a push stream.
