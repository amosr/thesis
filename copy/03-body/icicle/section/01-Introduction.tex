...
In the following example queries, we extend the daily stock price records from \autoref{taxonomy/gold-panning} to contain the open price and the close price for the day.
