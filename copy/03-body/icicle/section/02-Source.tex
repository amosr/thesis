...
Finally, our major caveat is that the @group@ construct we used in \autoref{icicle:s:ElementsAndAggregates} uses space proportional to the number of distinct \emph{keys} in the input stream.
