...
Next, in \cref{chapter:process:processes}, we shall see how to use Kahn process networks to concurrently execute multiple queries with multiple input streams.
