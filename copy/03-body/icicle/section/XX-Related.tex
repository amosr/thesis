...
In this environment, array fusion is considered a ``bonus'' optimization rather than integral part of the compilation method.
...
Next, in \REF{kpn}, we shall see how to use Kahn process networks to concurrently execute multiple queries with multiple input streams.
