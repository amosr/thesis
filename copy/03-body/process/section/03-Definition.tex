...
% -----------------------------------------------------------------------------
\chapter{Process definitions}
\input{copy/03-body/process/figures/ProcessDef.tex}
...
\input{copy/03-body/process/figures/ProcessInject}
\input{copy/03-body/process/figures/ProcessEval.tex}
\input{copy/03-body/process/figures/ProcessFeed.tex}
