...
\input{copy/03-body/process/figures/Fusion-types.tex}
\input{copy/03-body/process/figures/Fusion-fusePair.tex}
...
\input{copy/03-body/process/figures/Fusion-tryStepPair.tex}
...
\input{copy/03-body/process/figures/Fusion-tryStep.tex}
...
% -------------------------------------
\input{copy/03-body/process/figures/FusionUtils.tex}
